...
def main(args, DATASET):
    ...
    for f in [js, clean_tgt, clean_tgt_filter]:
        if not os.path.exists(f):
            ...
            print("{} does not exist, copying from ../../rotowire_fg/new_clean/{}/{}".format(f, DATASET, bname))
            shutil.copyfile("../../rotowire_fg/new_clean/{}/{}".format(DATASET, bname), f)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='extract_ext')
